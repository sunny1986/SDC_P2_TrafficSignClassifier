...
After training the model, testing the model involved finding out how the model performed on completely new images of traffic signs extracted from the web.
